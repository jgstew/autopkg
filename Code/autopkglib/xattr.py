...
def getxattr(path: str, attr: str, symlink: bool = False) -> Optional[str]:
    try:
        ...
        print("WARNING: xattr.getxattr threw OSError - expected in WSL")
        print(e)
        return None
...
def listxattr(path: str, symlink: bool = False) -> List[str]:
    try:
        ...
        print("WARNING: xattr.listxattr threw OSError - expected in WSL")
        print(e)
        return []
...
def removexattr(path: str, attr: str, symlink: bool = False) -> None:
    try:
        ...
        print("WARNING: xattr.removexattr threw OSError - expected in WSL")
        print(e)
        return None
...
def setxattr(
    ...
    try:
        ...
        print("WARNING: xattr.setxattr threw OSError - expected in WSL")
        print(e)
        return None
